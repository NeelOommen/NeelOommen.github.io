...
export default function Home() {
  return (
    <div className={styles.container}>
      ...
      <main>
        <div class="bg-black h-full w-full flex flex-col overflow-x-clip snap-y snap-mandatory scrollbar-hide scroll-smooth">
          ...
          <div class="relative h-screen w-screen flex justify-center items-center px-[2vw] snap-center">
              ...
              <div class="absolute left-0 w-screen">
                <div class="flex flex-col md:flex-row space-y-16 md:space-y-0">
                  ...
                  <img src="/images/profile_image.jpg" class="transform w-[300px] md:w-[350px] lg:w-[480px] hover:scale-110  left-4 rounded-xl shadow-2xl duration-300"/>
                </div>
              </div>
            </div>
          </div>
